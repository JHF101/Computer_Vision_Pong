...
import time
"""
The following repo was used as the Pong Game:
https://github.com/Bineeshkb/pong/blob/main/pong1.py

Modications to scoring and decorative aspects were
removed to ensure minimal interference with the objects
of interest
"""
...
# OBJECTS
# -------
paddle1 = Paddle( screen, WHITE, 100, HEIGHT//2 - 60, 40, 180 )
paddle2 = Paddle( screen, WHITE, WIDTH - 140, HEIGHT//2 - 60, 40, 180 )
ball = Ball( screen, WHITE, WIDTH//2, HEIGHT//2, 40 )
